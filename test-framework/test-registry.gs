function _main(
  ...
  const TEST_MODULES = {
    ...
    'sheets-chat': {
      ...
      integration: [
        // Add sheets-chat integration tests here
        // Example: 'sheets-chat/test/ChatFlow.integration.test'
      ]
    },
    ...
    'tools': {
      unit: [
        // Add tools unit tests here
        // Example: 'tools/test/SearchToolHandler.unit.test'
      ],
      integration: [
        // Add tools integration tests here
      ]
    },
